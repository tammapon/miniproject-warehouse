    ...
    for i in inputfile:
        ...
        if buffer[0] == "Set_path":
            ...
            for j in range(1,len(buffer)-1):
                if buffer[j] in ListOfTextbuffer:
                    Specialbuffer.append(buffer[j])
                else:
                    Namebuffer=Namebuffer+buffer[j]+" "
                if Namebuffer.strip(" ") in ListOfTextbuffer:
            ...
            for j in range(2,len(buffer)):
                if buffer[j] == "from" or buffer[j] == "to":
                    Specialbuffer.append(buffer[j])
        ...
        if i[0]=="Create":
            ...
            if i[1] in AirportNameList:
                if i[2] in AirportNameList:
                    AirportDict[i[1]].pathlist.append([AirportDict[i[2]],i[3]])
                    AirportDict[i[2]].pathlist.append([AirportDict[i[1]],i[3]])
                    ...
                    AirportDict[i[1]].pathlist.append([HarborDict[i[2]],i[3]])
                    HarborDict[i[2]].pathlist.append([AirportDict[i[1]],i[3]])
                    if i[1] not in list(GraphOfPath.keys()):
                        GraphOfPath[i[1]]=set([i[2]])
                    else:
                        GraphOfPath[i[1]] = GraphOfPath[i[1]]|set([i[2]])
                    ...
                    AirportDict[i[1]].pathlist.append([TrainstationDict[i[2]],i[3]])
                    TrainstationDict[i[2]].pathlist.append([AirportDict[i[1]],i[3]])
                    if i[1] not in list(GraphOfPath.keys()):
                        GraphOfPath[i[1]]=set([i[2]])
                    else:
                        GraphOfPath[i[1]] = GraphOfPath[i[1]]|set([i[2]])
                    ...
                    AirportDict[i[1]].pathlist.append([WarehouseDict[i[2]], i[3]])
                    WarehouseDict[i[2]].pathlist.append([AirportDict[i[1]], i[3]])
                    if i[1] not in list(GraphOfPath.keys()):
                        GraphOfPath[i[1]]=set([i[2]])
                    else:
                        GraphOfPath[i[1]] = GraphOfPath[i[1]]|set([i[2]])
                ...
                if i[2] in AirportNameList:
                    HarborDict[i[1]].pathlist.append([AirportDict[i[2]],i[3]])
                    AirportDict[i[2]].pathlist.append([HarborDict[i[1]],i[3]])
                    if i[1] not in list(GraphOfPath.keys()):
                        GraphOfPath[i[1]]=set([i[2]])
                    else:
                        GraphOfPath[i[1]] = GraphOfPath[i[1]]|set([i[2]])
                    ...
                    HarborDict[i[1]].pathlist.append([TrainstationDict[i[2]],i[3]])
                    TrainstationDict[i[2]].pathlist.append([HarborDict[i[1]],i[3]])
                    if i[1] not in list(GraphOfPath.keys()):
                        GraphOfPath[i[1]]=set([i[2]])
                    else:
                        GraphOfPath[i[1]] = GraphOfPath[i[1]]|set([i[2]])
                    ...
                    HarborDict[i[1]].pathlist.append([WarehouseDict[i[2]], i[3]])
                    WarehouseDict[i[2]].pathlist.append([HarborDict[i[1]], i[3]])
                    if i[1] not in list(GraphOfPath.keys()):
                        GraphOfPath[i[1]]=set([i[2]])
                    else:
                        GraphOfPath[i[1]] = GraphOfPath[i[1]]|set([i[2]])
                ...
                if i[2] in AirportNameList:
                    TrainstationDict[i[1]].pathlist.append([AirportDict[i[2]],i[3]])
                    AirportDict[i[2]].pathlist.append([TrainstationDict[i[1]],i[3]])
                    if i[1] not in list(GraphOfPath.keys()):
                        GraphOfPath[i[1]]=set([i[2]])
                    else:
                        GraphOfPath[i[1]] = GraphOfPath[i[1]]|set([i[2]])
                    ...
                    TrainstationDict[i[1]].pathlist.append([HarborDict[i[2]],i[3]])
                    HarborDict[i[2]].pathlist.append([TrainstationDict[i[1]],i[3]])
                    if i[1] not in list(GraphOfPath.keys()):
                        GraphOfPath[i[1]]=set([i[2]])
                    else:
                        GraphOfPath[i[1]] = GraphOfPath[i[1]]|set([i[2]])
                    ...
                    TrainstationDict[i[1]].pathlist.append([TrainstationDict[i[2]],i[3]])
                    TrainstationDict[i[2]].pathlist.append([TrainstationDict[i[1]],i[3]])
                    if i[1] not in list(GraphOfPath.keys()):
                        GraphOfPath[i[1]]=set([i[2]])
                    else:
                        GraphOfPath[i[1]] = GraphOfPath[i[1]]|set([i[2]])
                    ...
                    TrainstationDict[i[1]].pathlist.append([WarehouseDict[i[2]], i[3]])
                    WarehouseDict[i[2]].pathlist.append([TrainstationDict[i[1]], i[3]])
                    if i[1] not in list(GraphOfPath.keys()):
                        GraphOfPath[i[1]]=set([i[2]])
                    else:
                        GraphOfPath[i[1]] = GraphOfPath[i[1]]|set([i[2]])
                ...
                if i[2] in AirportNameList:
                    WarehouseDict[i[1]].pathlist.append([AirportDict[i[2]],i[3]])
                    AirportDict[i[2]].pathlist.append([WarehouseDict[i[1]],i[3]])
                    if i[1] not in list(GraphOfPath.keys()):
                        GraphOfPath[i[1]]=set([i[2]])
                    else:
                        GraphOfPath[i[1]] = GraphOfPath[i[1]]|set([i[2]])
                    ...
                    WarehouseDict[i[1]].pathlist.append([HarborDict[i[2]],i[3]])
                    HarborDict[i[2]].pathlist.append([WarehouseDict[i[1]],i[3]])
                    if i[1] not in list(GraphOfPath.keys()):
                        GraphOfPath[i[1]]=set([i[2]])
                    else:
                        GraphOfPath[i[1]] = GraphOfPath[i[1]]|set([i[2]])
                    ...
                    WarehouseDict[i[1]].pathlist.append([TrainstationDict[i[2]],i[3]])
                    TrainstationDict[i[2]].pathlist.append([WarehouseDict[i[1]],i[3]])
                    if i[1] not in list(GraphOfPath.keys()):
                        GraphOfPath[i[1]]=set([i[2]])
                    else:
                        GraphOfPath[i[1]] = GraphOfPath[i[1]]|set([i[2]])
                    ...
                    WarehouseDict[i[1]].pathlist.append([WarehouseDict[i[2]],i[3]])
                    WarehouseDict[i[2]].pathlist.append([WarehouseDict[i[1]],i[3]])
                    if i[1] not in list(GraphOfPath.keys()):
                        GraphOfPath[i[1]]=set([i[2]])
                    else:
                        GraphOfPath[i[1]] = GraphOfPath[i[1]]|set([i[2]])
...
def processOrder():
    ...
    for i in keyOrderList:
        ...
        for j in OrderDict[i].listevent:
            ...
            if FailBool[countevent] == False:
                if j[0] == 'Import':
                    if WarehouseDict[j[4]].capacity<len(WarehouseDict[j[4]].log)+int(j[1]):
                        FailBool[countevent]=True
                        FailNum += 1
                    else:
                    ...
                    if countiteminwarehouse<int(j[1]):
                        FailBool[countevent]=True
                        FailNum += 1
                    else:
                        for l in range(int(j[1])):
                    ...
                    if WarehouseDict[j[3]].name==WarehouseDict[j[4]].name:
                        pass
                    elif WarehouseDict[j[4]].capacity<len(WarehouseDict[j[4]].log)+int(j[1]):
                        FailBool[countevent]=True
                        FailNum += 1
                    else:
                        countiteminwarehouse = 0
    ...
    for i in list(TruckDict.keys()):
        print(TruckDict[i].name,'has traveled',TruckDict[i].distance,'km.')
    for i in SortLog:
